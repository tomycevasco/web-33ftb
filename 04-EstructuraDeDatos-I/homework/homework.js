...
function nFactorial(n) {
  ...
  return n * nFactorial(n - 1)
    ...
    // me daba error porque ponia que si n === 0 return 0, esto lo que hacia era multiplicaba todo por 0 y me quedaba 0
...
function nFibonacci(n) {
  ...
  // cuando yo llame a la funcion al final esta se va a seeguir llamando hasta el if por eso puede saber los valores anteriores
}
console.log(nFibonacci(7))
console.log(nFibonacci(7-1) + nFibonacci(7 - 2))
/*
